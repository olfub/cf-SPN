...
for factor in factors:
    file_names = list(glob.glob(f"../../runtimes/C_simpleMlp20_{loss}_l2_causalLoss_loss2factor_{factor}_uniform_interventions_{dataset_abrv}_ep80_100k/iSPN_SEED*/loss.pkl"))
    file_names.sort()
    print(file_names)
