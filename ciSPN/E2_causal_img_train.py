...
if __name__ == "__main__":
    ...
    if conf.model_name == "ciCNNSPN":
        rg, params, spn = create_spn_model(num_target_vars, num_condition_vars, conf.seed, nn_provider=create_cnn_for_spn, setup="hiddenObject")
        model = spn
    ...
    # setup loss
    loss, loss_ispn = create_loss(conf.loss_name, conf, nn_provider=create_cnn_for_spn,
                                  load_dir=runtime_base_dir / get_E2_loss_path("hiddenObject", conf.loss_load_seed))
