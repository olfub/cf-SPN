...
parser.add_argument("--dataset", choices=["ASIA", "CANCER", "EARTHQUAKE"], default="ASIA")
...
experiment_name = get_experiment_name(conf.dataset, conf.model_name, conf.seed, None, None, None)
...
for (dataset_path_train, dataset_path_test) in zip(reversed(dataset_paths_train), reversed(dataset_paths_test)):
