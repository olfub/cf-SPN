...
class HiddenObjectDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root_dir, image_transform, add_intervention_channel=True, split="train"):
    ...
    def __getitem__(self, item):
        ...
        if self.add_intervention_channel:
            iimg = self._create_intervention_image(self.interventions[item], (image.shape[1], image.shape[2])) # fixme right dimension?
